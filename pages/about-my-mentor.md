...
graduate_mentor:
  ...
  bio: |
    Farouk is a PhD student and computer scientist specializing in the application of machine learning, artificial intelligence, and deep learning to solve complex, real-world challenges. They have been an invaluable mentor, consistently helping me bridge the gap between theoretical models and tangible clinical applications, while providing expert guidance as I navigate the complexities of my own research pipeline.

    Their work at the Centre for Equitable AI and Machine Learning Systems, combined with their extensive background in everything from sports analytics to prostate cancer gene discovery, has been a major source of inspiration for my own work. Outside of their research, Farouk is an avid soccer player, a passionate chess enthusiast, and enjoys building with Legos.
